...
<body>
	...
	%>
	<a href="RequestParameter.jsp?name<%=encodeName%>&id=hong&sex=man&favorite=&self_intro">
	Get방식
	</a>
	<br /><br />
	<script>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp" onsubmit="return checkForm(this);">
		...
		관심사항 : 
			...
			<input type="checkbox" name="favorite" value="sport"/>경제
			<input type="checkbox" name="favorite" value="sport"/>정치
		<br />
		성별:
		...
		<br />
		자기소개:
		<textarea name="self_intro" cols="30" rows="10">나는 부유한집안에서 태어나 대충 자라...
		</textarea>
		<br />
		<input type="submit" value="Post방식" />
	</form>
