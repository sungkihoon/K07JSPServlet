...
<%-- 
	EL에서 Java클래스의 메소드 호출 절차 및 방법
	 1. 클래스와 메소드를 정의한다. 단, 메소드 정의시 반드시 public 
		static 으로 선언해야 한다.
	 ...
	 3. web.xml에 내가 정의한 태그라이브러리 파일을 생성한다.
	 	taglib_url JSP의 taglib지시어의 uri속성에 삽입할 값
...
<body>
	...
	<h3>Java 메소드 호출하기</h3>
	<ul>
		<li>MyTagLib.isNumber("100") => <%=MyTagLib.isNumber("100") %>
		</li>
	</ul>
